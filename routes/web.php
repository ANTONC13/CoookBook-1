...
Route::get(  'user',                      'UserController@index'      )->name( 'user.index'     )->middleware('auth')->middleware('authroot');
Route::get(  'user/{user}/delete',        'UserController@destroy'    )->name( 'user.delete'    )->middleware('auth')->middleware('authroot');
Route::get(  'user/create',               'UserController@create'     )->name( 'user.create'    )->middleware('auth')->middleware('authroot');
Route::post( 'user',                      'UserController@store'      )->name( 'user.store'     )->middleware('auth')->middleware('authroot');
Route::get(  'user/{user}/edit',          'UserController@edit'       )->name( 'user.edit'      )->middleware('auth')->middleware('authroot');
Route::post( 'user/{user}/update',        'UserController@update'     )->name( 'user.update'    )->middleware('auth')->middleware('authroot');
